        ...
        <div class="reviews">
            ...
            <swiper :slidesPerView="2" :spaceBetween="30" :centeredSlides="true" :loop="true" :pagination="pagination"
                ...
                <swiper-slide>
                    <div class="slide">
                        <div class="name d-flex justify-content-between align-items-center">
                            <span>Айдан Аскарова</span>
                            <small>12.08.2023</small>
                        </div>

                        <p>Я работаю с сайтом Domeinica для покупки и продажи доменов. Это удобная платформа, которая
                            помогает увеличить ценность моих доменов при продаже. В случае необходимости я всегда могу
                            обратиться за поддержкой на сайте Domeinica. Польза в том, что продажа моих доменов происходит
                            легко и удобно, и я доволен всеми услугами Domeinica.</p>
                    </div>
                </swiper-slide>
                <swiper-slide>
                    <div class="slide">
                        <div class="name d-flex justify-content-between align-items-center">
                            <span>Айнұр Жумабеков</span>
                ...
                <swiper-slide>
                    <div class="slide">
                        <div class="name d-flex justify-content-between align-items-center">
                            <span>Тимур Сәттаров</span>
                            <small>21.09.2023</small>
                        </div>

                        <p>Использование сайта Domeinica оказалось очень полезным для улучшения и продажи моих доменов.
                            Процесс нахождения и продажи доменов легко выполняется через этот сайт. Мне нравится, как просто
                            можно использовать этот сайт для улучшения и продажи моих доменов.</p>
                    </div>
                </swiper-slide>
                <swiper-slide>
                    <div class="slide">
                        <div class="name d-flex justify-content-between align-items-center">
                            <span>Гүлжан Өмірбек</span>
                            <small>10.10.2023</small>
                        </div>

                        <p>Я очень довольна работой на сайте Domeinica. Это отличная платформа для продажи и улучшения
                            доменов. Сайт предоставляет множество удобных функций и высококачественное обслуживание для
                            клиентов. Я использую этот сайт для улучшения и продажи доменов, и результаты просто
                            потрясающие.</p>
                    </div>
                </swiper-slide>
...
.main {
    ...
    div {
        ...
        h1 {
            ...
            span {
                background: linear-gradient(225deg, #FF7D34 0%, #C70012 100%);
                color: #000 !important;
